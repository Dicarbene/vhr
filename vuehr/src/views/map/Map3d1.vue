  ...
  <div>
    ...
    <el-dialog title="地图展示" :visible.sync="dialogVisible_show" width="80%">
        ...
        <el-container>
          <el-aside style="width: 100%;">
            <vl-map :load-tiles-while-animating="true" :load-tiles-while-interacting="true" style="height: 800px;"
              ...
              <vl-view :zoom.sync="location.zoom" :center.sync="location.center" :rotation.sync="location.rotation">
              </vl-view>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="small" @click="dialogVisible_show = false"> 退 出 </el-button>
      </span>
    </el-dialog>
    ...
    -->
    <el-dialog title="增加地图" :visible.sync="dialogVisible_add" width="90%">
      <div>
        <div>
          <el-tag>地图名称</el-tag>
      ...
      <iframe src="http://39.106.69.201:4111/newKey.html#" frameborder="0" width="100%" height="600px"></iframe>
      <span slot="footer" class="dialog-footer">
